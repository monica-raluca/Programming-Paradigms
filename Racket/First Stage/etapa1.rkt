...
(define (st-has-pattern? st pattern)
  (cond
    ((null? pattern) #t)
    ((has-pattern (get-branch-label (get-ch-branch st (car pattern))) pattern) (st-has-pattern? st (list-tail pattern (length (get-branch-label (get-ch-branch st (car pattern)))))))
