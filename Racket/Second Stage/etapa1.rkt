...
(define (longest-common-prefix-of-list words)
  (longest-common-prefix-of-list-rec words (car words))
  )
...
(define (st-has-pattern? st pattern)
  (cond
    ...
    ((has-pattern (get-branch-label (get-ch-branch st (car pattern))) pattern) (st-has-pattern? (get-branch-subtree (get-ch-branch st (car pattern))) (list-tail pattern (length (get-branch-label (get-ch-branch st (car pattern)))))))
